...
from .views import transfer_create, transfer_update, transfer_delete, transfer_list, account_transfer, transfer_detail
...
urlpatterns = [
    ...
    path('transfers/account-transfer/', account_transfer, name='account_transfer'),
]
