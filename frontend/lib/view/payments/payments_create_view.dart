...
class PaymentsCreateView extends StatefulWidget {
  const PaymentsCreateView({super.key});

  @override
  _PaymentsCreateViewState createState() => _PaymentsCreateViewState();
}

class _PaymentsCreateViewState extends State<PaymentsCreateView> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    if (pickedDate != null) {
      setState(() {
        _paymentDateController.text = DateFormat('yyyy-MM-dd').format(pickedDate);
      });
    }
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              datePickerField('Select Payment Date', _paymentDateController),
              const SizedBox(height: 20),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    print('Payment created with amount: ${_amountController.text}');
                    print('Payment Date: ${_paymentDateController.text}');
