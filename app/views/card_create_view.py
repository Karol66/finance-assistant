...
class Expanse(UserControl):
    ...
    def add_card(self, e):
        ...
        self.card_controller.create_card(self.user_id, card_name, card_number, cvv,
                                                 card_type, balance)
                ...
                controls=[
                    Container(
                        ...
                        content=Column(
                            spacing=10,
                            controls=[
                                self.InputTextField("Card name", False, self.card_name_input, width="100%"),
                                self.InputTextField("Card number", False, self.card_number_input, width="100%"),
                                self.InputTextField("CVV", False, self.cvv_input, width="100%"),
                                Container(
...
def create_card_page(page: Page):
    ...
    page.add(
        ...
        AppBar(
            ...
            title=Text('Create card', color="white"),
            bgcolor="#132D46",
        ),
    )
    page.update()
