...
class Expanse(UserControl):
    ...
    def create_datepicker(self):
        ...
        self.date_text = Text("Pick date", size=14)  # Placeholder text, który zostanie zaktualizowany po wyborze daty
            ...
            content=Row(
                controls=[
                    ...
                    Container(
                        ...
                        margin=margin.only(right=5)  # Margines po prawej stronie, aby przesunąć ikonę w lewo
                    )
                ],
                alignment="spaceBetween",  # Rozciągnięcie tekstu na całą szerokość, ikona na prawo
                expand=True,  # Powoduje, że Row zajmuje całą dostępną szerokość
            ),
            style=ButtonStyle(
                bgcolor="#f0f3f6",
                color="black",
